                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" x-model="bookingForm.user_name" required
                                           ...
                                           list="book-for-user-options-calendar"
                                           placeholder="Enter user name..."
                                           class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500">
                                    <datalist id="book-for-user-options-calendar">
                                        <template x-for="match in bookForUserMatches" :key="`calendar-book-user-${match.id}`">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">
                                     ...
                                     <select x-model.number="bookingForm.attendees" required
                                           class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500">
                                        <template x-for="option in attendeeOptions" :key="`calendar-attendees-${option.value}`">
