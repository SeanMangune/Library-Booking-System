        ...
        <div class="p-6 flex-1 min-h-0 overflow-y-auto">
            ...
            <template x-if="selectedBooking?.status === 'approved'">
                <div class="flex flex-col items-center justify-center mt-6">
                    <h3 class="text-lg font-semibold text-emerald-700 mb-4">This booking is already approved</h3>
                    <div class="inline-block p-4 bg-white border-2 border-gray-200 rounded-xl shadow-sm mb-2">
                    ...
                    <span class="inline-flex items-center px-4 py-1 mt-4 rounded-full text-sm font-semibold bg-emerald-100 text-emerald-700">
                        Approved
                    </span>
                </div>
            </template>
