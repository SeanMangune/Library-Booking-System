            ...
            <div class="relative w-full max-w-md bg-white rounded-2xl shadow-2xl transform transition-all"
                ...
                <div class="p-6">
                    ...
                    <div class="bg-gray-50 rounded-xl p-4 mb-6">
                        <div class="grid grid-cols-2 gap-4 text-sm">
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-gray-900" x-text="approvedBooking?.formatted_time"></p>
                            </div>
                            <div>
                    ...
                    <div class="text-center mb-6">
                        ...
                        <div class="inline-block p-4 bg-white border-2 border-gray-200 rounded-xl shadow-sm">
                            <template x-if="approvedBooking?.qr_code_url">
                                <img :src="approvedBooking.qr_code_url" alt="Booking QR Code" class="w-48 h-48 mx-auto">
                            </template>
                            <template x-if="!approvedBooking?.qr_code_url">
                    ...
                    <div class="flex gap-3">
                        ...
                        <template x-if="approvedBooking?.qr_code_url">
                            <a :href="approvedBooking.qr_code_url" 
                               download
                               class="px-4 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl font-medium transition-all flex items-center gap-2">
    ...
    return {
        ...
        async approveBooking() {
            ...
            try {
                ...
                if (data.success) {
                    // Store the approved booking with QR code info
                    this.approvedBooking = data.booking || {
                        ...this.selectedBooking,
                        booking_code: data.booking?.booking_code,
                        qr_code_url: data.booking?.qr_code_url
                    };
